...
import my.netty.echo.echohandler.ClientHandler;
import my.netty.echo.encoder.MyLengthFieldBasedFrameEncoder;
...
public class EchoClient1 {
            ...
            bootstrap.group(guestGroup)
                    ...
                    .handler(new ChannelInitializer<SocketChannel>() {
                        ...
                        protected void initChannel(SocketChannel ch) throws Exception {
                            ...
                            channelPipeline.addLast(new MyLengthFieldBasedFrameEncoder());
    ...
    public static void main(String[] args){
        new EchoClient1("127.0.0.1", 8080).start();
    }
