...
public class TestBuffer {
	...
	public void testReset() {
		...
		print(allocate);
		System.out.println("\n" + new String(dst3, 0, dst3.length));

		System.out.println("==============flip-compact==================");
		allocate.compact();
		print(allocate);

		System.out.println("==============get==================");
		byte[] dst4 = new byte[allocate.limit()];
		allocate.get(dst4, 0, 5);
		print(allocate);
		System.out.println("\n" + new String(dst4, 0, dst4.length));

		System.out.println("==============clear==================");
		allocate.clear();
		print(allocate);

		System.out.println("==============flip-write==================");
		allocate.flip();
		print(allocate);
	...
	public void testByte() {
		...
		allocate.clear();  //allocate.compact()清除以读数据
		System.out.println("==============clear=================");
		print(allocate);
	...
	public void print(Buffer allocate) {
		System.out.println("position: " + allocate.position()); //获取缓冲区中可以操作的位置
		System.out.println("limit: " + allocate.limit());    //获取缓冲区中剩余的容量
		System.out.println("capacity: " + allocate.capacity()); //获取缓冲区的容量
	}
