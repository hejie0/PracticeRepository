...
public class JsonMapper extends ObjectMapper {
	...
	public static String toJsonString(Object object, Class<?> view) {
		try {
			return JsonMapper.getInstance().disable(MapperFeature.DEFAULT_VIEW_INCLUSION)
					.writerWithView(view).writeValueAsString(object);
