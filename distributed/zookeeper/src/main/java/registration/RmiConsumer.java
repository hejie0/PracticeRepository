...
public class RmiConsumer {
    ...
    private static final Logger log = LoggerFactory.getLogger(RmiConsumer.class);
    private String connectString = "192.168.50.144:2181," +
            "192.168.50.144:2182," +
            "192.168.50.144:2183";
    ...
    private void watchNode(final ZooKeeper zk) {
        try {
            List<String> nodeList = zk.getChildren(registry, event -> {
            ...
            for (String node : nodeList) {
                byte[] data = zk.getData(registry + "/" + node, false, null); // 获取 /registry 的子节点中的数据
